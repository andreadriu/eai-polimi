...
#ifndef STEVAL_STWINKT1B_CONF_H
#define STEVAL_STWINKT1B_CONF_H
...
/** @defgroup STEVAL_STWINKT1B_CONFIG Config
  * @{
  */

/** @defgroup STEVAL_STWINKT1B_CONFIG_Exported_Constants
  * @{
  */
/* COM Feature define */
