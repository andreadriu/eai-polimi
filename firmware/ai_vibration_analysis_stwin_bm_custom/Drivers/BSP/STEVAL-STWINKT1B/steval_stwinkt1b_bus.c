...
/** @defgroup STEVAL_STWINKT1B_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STEVAL_STWINKT1B_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STEVAL_STWINKT1B_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup STEVAL_STWINKT1B_LOW_LEVEL_Private_Functions STEVAL_STWINKT1B LOW LEVEL Private Functions
  * @{
  */

/** @defgroup STEVAL_STWINKT1B_BUS_Exported_Functions STEVAL_STWINKT1B_BUS Exported Functions
  * @{
  */
